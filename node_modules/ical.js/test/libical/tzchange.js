...
let comps = ICAL.parse(denvertz);
let tzcomp = new ICAL.Component(comps[1]);
let zone = new ICAL.Timezone(tzcomp);


let dtstr = "20031026T190000";

if (arguments.length > 0) {
  dtstr = arguments[0]
}

let tt = ICAL.Time.fromDateTimeString(ICAL.design.value["date-time"].fromICAL(dtstr));
tt.zone = zone;

dump("OFFSET for " + tt + " is " + tt.utcOffset() + "\n");
